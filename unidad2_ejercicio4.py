...
2.Define una función principal que:
...
3.Ejecuta la función principal si se ejecuta como script
...
def main():
    ...
    if not all(
        isinstance(age, int) and age >= 0 for age in retirement_age_limits.values()
    ):
