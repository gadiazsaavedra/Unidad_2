...
He aquí una explicación del código de Unidad2_ejercicio1.py:

Importa el módulo sys para obtener los argumentos de la línea de comandos.

Define una función filter_even_numbers que:
...
Define una función print_even_numbers que:
