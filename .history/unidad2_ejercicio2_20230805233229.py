...
3.Inicia un bucle while que iterará 2 veces (cuando i < 2).
...
1.Después del bucle, crea una sentencia usando el formato f-string con las dos frutas almacenadas en fruits[0] y fruits[1].

2Imprime la sentencia.
