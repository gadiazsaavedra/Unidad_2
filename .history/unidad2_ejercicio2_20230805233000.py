"""
Crea una lista vacía llamada fruits para almacenar los nombres de frutas introducidos por el usuario.

Inicializa una variable contador i a 0. Se utilizará para controlar el número de iteraciones.

Inicia un bucle while que iterará 2 veces (cuando i < 2).
...
Después del bucle, crea una sentencia usando el formato f-string con las dos frutas almacenadas en fruits[0] y fruits[1].
