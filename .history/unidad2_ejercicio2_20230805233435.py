...
los almacena en una lista e imprime una sentencia utilizando esas frutas.
El bucle while itera dos veces para obtener las dos entradas. La validación de la entrada se realiza para comprobar si hay cadenas alfabéticas.
