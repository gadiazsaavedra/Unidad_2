...
En esta versión, la función map se utiliza para convertir cada argumento en un número entero, y para crear una lista de cadenas que representan cada número par. La función filter se utiliza para eliminar los argumentos no numéricos. 
"""
