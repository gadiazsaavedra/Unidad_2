...
1.Luego, crea una sentencia usando el formato f-string con
las dos frutas almacenadas en fruits[0] y fruits[1].

2.Imprime la sentencia.

En general, pide al usuario que introduzca dos nombres de frutas,
los almacena en una lista e imprime una sentencia utilizando esas frutas. El bucle while itera dos veces para obtener las dos entradas. La validación de la entrada se realiza para comprobar si hay cadenas alfabéticas.
