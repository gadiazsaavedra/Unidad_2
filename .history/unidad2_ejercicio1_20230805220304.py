...
contenga sólo los números pares de la lista de entrada. La función print_even_numbers crea una lista de cadenas que representan cada número par y, a continuación, las une con caracteres de nueva línea para crear la cadena de salida final."""
